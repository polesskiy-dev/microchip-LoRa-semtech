...
struct LoRa_settings_t LoRa_settings;
...
bool initLoRaDriver(bool (*SPI_WriteRead)(void* pTransmitData, size_t txSize, void* pReceiveData, size_t rxSize);
                    ...
                    bool (*SPI_IsBusy)(void);
                    bool (*SPI_IsTransmitterBusy)(void)) {
    LoRa_settings.SPI_WriteRead = SPI_WriteRead;
    LoRa_settings.SPI_Write = SPI_Write;
    LoRa_settings.SPI_Read = SPI_Read;
    LoRa_settings.SPI_IsBusy = SPI_IsBusy;
    LoRa_settings.SPI_IsTransmitterBusy = SPI_IsTransmitterBusy;
